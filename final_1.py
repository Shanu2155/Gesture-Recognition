...
class MotionDetectorInstantaneous():
    ...
    def __init__(self, threshold=80,  showWindows=True):
    ...
    def run(self):
        ...
        process=('notepad.exe','WINWORD.EXE','chrome.exe','IEXPLORE.exe','ois.exe','dllhost.exe','excel.exe','mpc-hc.exe','wmplayer.exe','wordpad.exe','calc.exe','powerpnt.exe','firefox.exe')
        fle = open('abc.txt', 'w')
